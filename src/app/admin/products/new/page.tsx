...
export default function AddProductPage() {
  ...
  return (
    <div>
      <div className="mb-10">
        <h2 className="text-2xl font-light tracking-[0.2em] uppercase">Add New Product</h2>
        <p className="text-sm text-black/40 mt-1">Fill in the details to add a new fragrance.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white border border-black/5 p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-[10px] uppercase tracking-[0.2em] text-black/50 mb-2">Price (Tk) *</label>
